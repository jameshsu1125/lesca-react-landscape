...
var Landscape = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: state && ((0, jsx_runtime_1.jsx)("div", { style: __assign({ position: 'fixed', width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', top: '0', left: '0' }, style), children: children || (0, jsx_runtime_1.jsx)(DefaultChildren, {}) })) }));
};
